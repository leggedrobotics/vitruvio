function [interpolatedPositionData, interpolatedVelocityData, interpolatedForceData, interpolatedBodyRotationData, interpolatedBasePosition] = generateAdditionalPoints(relativeMotionHipEE, EE, C_IBody, EEselection, base)
    ...
    tempBasePosition = nan(2*length(base.position),3);       
    ...
    for i = 1:length(base.position)
        tempBasePosition(2*i-1,:) = base.position(i,:);
    end
