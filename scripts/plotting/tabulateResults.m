...
function [] = tabulateResults(data, task)
   ...
   for i = 1:legCount
      ...
      Nominal_Leg =  [string(EEselection); ...
                      ...
                      strjoin(string(data.(task).(EEselection).linkMass(1,:))); ...
                      ...
                      strjoin(string(data.(task).(EEselection).kSpringJoint(1,1:linkCount+1)))];
   
     if data.(task).basicProperties.optimizedLegs.(EEselection) 
        Optimized_Leg = [string(EEselection); ...
                         strjoin(string(data.(task).(EEselection).linkLengthsOpt(1,:))); ...
                         strjoin(string(data.(task).(EEselection).linkMassOpt(1,:))); ...
                         ...
                         strjoin(string(data.(task).(EEselection).kSpringJointOpt(1,1:linkCount+1)))];   
