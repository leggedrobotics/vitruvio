function [] = tabulateResults(data, task)
   ...
   T1 = table(Basic_Properties, 'RowNames', rowNames)
    ...
    T2 = table(Optimization_Properties, 'RowNames', rowNames)
   ...
   for i = 1:legCount
     ...
     if data.(task).basicProperties.optimizedLegs.(EEselection) 
        ...
        T3 = table(Nominal_Leg, Optimized_Leg, 'RowNames', rowNames)
     else 
       T3 = table(Nominal_Leg, 'RowNames', rowNames)
     end          
end