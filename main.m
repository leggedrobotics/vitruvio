...
optimizationProperties.options.populationSize = 3;
...
optimizationProperties.allowableExtension              = 0.7; % penalize extension above this ratio of total possible extension
