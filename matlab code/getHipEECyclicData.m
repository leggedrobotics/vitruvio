...
function [meanCyclicMotionHipEE, cyclicMotionHipEE, cyclicC_IBody, samplingStart, samplingEnd] = getHipEECyclicData(tLiftoff, tTouchdown, relativeMotionHipEE, EE, removalRatioStart, removalRatioEnd, dt, minStepCount, C_IBody)
...
for i = 1:minStepCount-2
    ...
    cyclicC_IBody(:,:,:) = temp.rotation(:,:,1:indexMax);
end
