...
yNom.LF = quadruped.yNom;

xNom.LH = -quadruped.xNom;
yNom.LH = quadruped.yNom;

xNom.RF = quadruped.xNom;
yNom.RF = -quadruped.yNom;

xNom.RH = -quadruped.xNom;
yNom.RH = -quadruped.yNom;
...
setFixedTransform(jnt2, eye(4)); % update later for hip attachment position
